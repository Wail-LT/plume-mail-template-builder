...
--------------------
Just run the `coreoz.WebApplication` class, you can then open your browser to <http://localhost:8080>.
...
you can run the `coreoz.db.QuerydslGenerator.main()` method.
			...
			<configuration>
				<transformers>
					...
					<transformer
						...
						<mainClass>coreoz.WebApplication</mainClass>
					</transformer>
				</transformers>
			</configuration>
		</execution>
